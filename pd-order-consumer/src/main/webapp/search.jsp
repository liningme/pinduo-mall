...
<body>
	<div class="big">
		<form name="" action="" method="post">
			<section id="section">
				<p class="header">全部结果>${ param.key }>${page.number+1}</p>
				<div id="content_box">
				<c:forEach items="${page.content}" var="solrItem">
					<div class="lf" id="d1">
						<div class="img">
				...
				<a href="?key=${param.key}&page=${page.number-1}">上一页</a>
				<a href="?key=${param.key}&page=${page.number+1}">下一页</a>
